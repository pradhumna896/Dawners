...
class PaymentPagedDotSlider extends StatelessWidget {
          ...
          Row(
              ...
              children:[
                AnimatedContainer(
                  ...
                  width:data. cardIndexPayment == 0?18: 6,
                  height: 6,
                ...
                AnimatedContainer(
                  duration: const Duration(milliseconds: 500),
                  margin: const EdgeInsets.only(right: 5.0),
                  width:data. cardIndexPayment == 1?18: 6,
                  height: 6,
                  decoration: BoxDecoration(
                      color:Color(0xff6739B7),
                      borderRadius: BorderRadius.circular(6.0)),
                ...
                AnimatedContainer(
                  duration: const Duration(milliseconds: 500),
                  margin: const EdgeInsets.only(right: 5.0),
                  width: data. cardIndexPayment == 2?18:6,
                  height: 6,
                  decoration: BoxDecoration(
                      color:Color(0xff6739B7),
                      borderRadius: BorderRadius.circular(6.0)),
