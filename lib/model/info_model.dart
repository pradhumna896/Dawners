class InfoModel {
  ...
  InfoModel({this.data, this.societyAddress, this.message});

  InfoModel.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? new Data.fromJson(json['data']) : null;
    societyAddress = json['society_address'] != null
        ? new SocietyAddress.fromJson(json['society_address'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.societyAddress != null) {
      data['society_address'] = this.societyAddress!.toJson();
    }
...
class SocietyAddress {
  ...
  SocietyAddress({this.societyName});

  SocietyAddress.fromJson(Map<String, dynamic> json) {
