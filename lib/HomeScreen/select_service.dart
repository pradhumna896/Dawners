              ...
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: ListView.builder(
                      ...
                      itemCount:
                          ScheduleServiceModel.scheduleServiceModel.length,
                              ...
                              children: [
                                  ...
                                  child: Center(
                                    child: SvgPicture.asset(
                                      ScheduleServiceModel
                                          .scheduleServiceModel[index].image,
                                      height: 30,
                                      width: 30,
                                    ),
                                  ),
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      ScheduleServiceModel
                                          .scheduleServiceModel[index].title,
                                      style: TextStyle(
                                          color: Color(0xff0E1012),
                                          fontFamily: "Montserrat",
                                          fontWeight: FontWeight.w700,
            ...
            child: CustomButton(
                ...
                onclick: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (ctx) => SelectServiceSlot(
                                vehicleNumber: "MH-12-KC-1213",
                                typeOfService: "Interior",
                              )));
                }),
          ),
          Gap(20),
